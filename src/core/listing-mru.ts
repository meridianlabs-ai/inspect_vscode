...
export class ListingMRU {
  constructor(
    private readonly mruKey_: string,
  ...
  public async clear(): Promise<void> {
    await this.context_.workspaceState.update(this.mruKey_, []);
  }

  private getStoredMRU(): string[] {
    return this.context_.workspaceState.get<string[]>(this.mruKey_) || [];
  }
}
